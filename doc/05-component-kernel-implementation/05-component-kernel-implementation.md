...
I decided to represent Sailor using 4 instance variables. I don't know if this is allowed, but I'm doing it anyway. The four variables will be: int experience, int saltiness, int yearsForeTheMast, and String rank. I chose this because it directly matches my compenents states and there weren't any other components that made sense to me to use.
...
- Designed kernel implementation for Sailor component

### Updated

- Updated 'SailorKernel' to use advanceRank in the kernel
